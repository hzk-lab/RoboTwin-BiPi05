...
class TrainConfig:
    ...
    checkpoint_base_dir: str = "/data1/datasets/rbtLe/ckpts"
...
_CONFIGS = [
    ...
    # pi0_base by lora
    TrainConfig(
        name="bi0_base_aloha_robotwin_lora",
        checkpoint_base_dir = f"/data1/datasets/rbtLe/ckpts/{task}/",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m"),
        data=LeRobotAlohaDataConfig(
            repo_id=task,  # your datasets repo_id
            adapt_to_pi=False,
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            ...
            allowed_param_prefixes=("PaliGemma",),
        ),
    ...
    # bi0_base by full
    TrainConfig(
        name="bi0_base_aloha_robotwin_full",
        checkpoint_base_dir = f"/data1/datasets/rbtLe/ckpts/{task}/",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id=task,  # your datasets repo_id
