...
class AlohaOutputs(transforms.DataTransformFn):
    ...
    - Input: [left_7, pad_9, right_7, pad_9] = 32D
    - Output: [left_7, right_7] = 14D
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        if self.dual_arm:
            half_dim = actions.shape[-1] // 2
            left_actions = actions[:, :half_dim][..., :self.actual_arm_dim]
            right_actions = actions[:, half_dim:][..., :self.actual_arm_dim]
